...
You would need to have the latest version of [VS Code](https://code.visualstudio.com) and VS Code [Chrome Debugger Extension](https://NomadAsset.visualstudio.com/items?itemName=msjsdiag.debugger-for-chrome) installed.
